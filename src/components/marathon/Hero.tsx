  ...
  return (
    ...
    >
      ...
      >
        <img
          src={heroImage}
          alt="Marathon runners at golden hour"
      ...
      <div className="container-editorial relative z-10 flex h-full flex-col justify-end pb-20 md:pb-28">
        ...
        <div className="overflow-hidden">
          <motion.h1
            ...
            className="font-display text-display-xl font-bold uppercase tracking-wide text-cream"
          >
            Student Council
          </motion.h1>
        </div>
        ...
        >
          <button
            ...
            className="group relative overflow-hidden bg-primary px-10 py-5 font-display text-sm font-semibold uppercase tracking-widest text-primary-foreground transition-all duration-300 hover:bg-primary/90"
          >
